    ...
    <div className="pt-24 px-6 md:px-14">
      <section className="w-full flex flex-col md:flex-row items-center md:items-end justify-center  ">
        ...
        <div className="relative w-full md:w-1/2 flex justify-center">
          <img
            src="a.jpg" // Change this to your actual image path
        ...
        <div className="w-full md:w-1/2 md:my-30 my-8 md:mt-0 text-center md:text-left md:pl-14">
          <h3
          ...
          <p className="text-[#888888]   mt-4 text-justify">
